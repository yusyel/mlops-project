...
#%%
def split():
    df_full_train, df_test = train_test_split(read(), test_size=0.2, random_state=1)
...
def dicts():
    ...
    return X_train, X_val, train_dicts, val_dicts 
#%%
space = {
...
# In[50]:
def objective(space):
    X_train, X_val, train_dicts, val_dicts = dicts()
    df_train, df_val, df_test, y_train, y_val, y_test = split()
